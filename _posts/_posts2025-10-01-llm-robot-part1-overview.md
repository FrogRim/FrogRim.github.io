좋습니다! 영어/한국어 전환 가능하고, author 정보 없이 범용적으로 사용할 수 있도록 다시 작성하겠습니다.

---

# 📝 Part 1: 이중 언어 버전 (영어 ↔ 한국어)

## 구현 방법

Jekyll에서 다국어를 구현하는 방법:

### 옵션 1: 탭 방식 (JavaScript) ⭐ 추천
- 같은 페이지에서 버튼 클릭으로 언어 전환
- 깔끔하고 사용자 친화적
...
**옵션 1 (탭 방식)으로 진행하겠습니다!**

---

# 📄 포스트 파일

## `_posts/2025-10-01-llm-robot-part1-overview.md`
